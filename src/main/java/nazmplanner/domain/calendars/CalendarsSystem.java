package nazmplanner.domain.calendars;
...
import nazmplanner.infrastructure.persistence.calendars.JSONCalendarEventRepository;

public class CalendarsSystem
{
    private CalendarEventRepository calendarEventRepository;
    
    public CalendarsSystem()
    {
